module github.com/LSDXXX/servers/chatgpt

go 1.18

require github.com/LSDXXX/libs v0.0.0
...
require (
	github.com/LSDXXX/sql v0.0.0 // indirect
...
replace github.com/LSDXXX/libs v0.0.0 => ../../libs

replace github.com/LSDXXX/sql v0.0.0 => ../../sql
