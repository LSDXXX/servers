...
func TestStringToTimeDurationHookFunc(t *testing.T) {
	...
	timeValue := ValueOf(time.Duration(5))
	strValue := ValueOf("")
	cases := []struct {
		f, t   reflect.Value
		result interface{}
		...
		{ValueOf("5s"), timeValue, 5 * time.Second, false},
		{ValueOf("5"), timeValue, time.Duration(0), true},
		{ValueOf("5"), strValue, "5", false},
	}
...
func TestStringToTimeHookFunc(t *testing.T) {
	...
	cases := []struct {
		...
		{ValueOf("2006-01-02T15:04:05Z"), timeValue, time.RFC3339,
...
func TestStringToIPHookFunc(t *testing.T) {
	strValue := ValueOf("5")
	ipValue := ValueOf(net.IP{})
	cases := []struct {
		f, t   reflect.Value
		result interface{}
		err    bool
	}{
		{ValueOf("1.2.3.4"), ipValue,
...
func TestTextUnmarshallerHookFunc(t *testing.T) {
	cases := []struct {
		...
		{ValueOf("42"), ValueOf(big.Int{}), big.NewInt(42), false},
		{ValueOf("invalid"), ValueOf(big.Int{}), nil, true},
		{ValueOf("5"), ValueOf("5"), "5", false},
	}
